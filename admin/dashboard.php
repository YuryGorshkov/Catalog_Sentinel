...
<div class="gcs-dashboard">
    ...
    <section class="gcs-mode <?= $escape($modeClass) ?>">
        ...
        <div><h2><?= $escape(Loc::getMessage('GCS_MODE')) ?>: <?= $escape($modeLabel) ?></h2><p><?= $escape($modeDescription) ?></p></div>
    ...
    <div class="gcs-grid">
        ...
        <section class="gcs-panel">
            <h2><?= $escape(Loc::getMessage('GCS_LATEST_IMPORTED')) ?></h2>
    ...
    <section class="gcs-panel gcs-baselines">
        <h2><?= $escape(Loc::getMessage('GCS_BASELINE_STATUS')) ?></h2>
